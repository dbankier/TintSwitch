...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','com.yydigital.tintswitch.js')
	...
	f = os.path.join(cwd,'Classes','ComYydigitalTintswitchModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','com.yydigital.tintswitch.js']
